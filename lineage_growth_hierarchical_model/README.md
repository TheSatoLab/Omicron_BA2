...
![\bm{\beta_{lc}}\sim\ Student\_t(6,\bm{\beta_l},\bm{\sigma_{l}})](https://latex.codecogs.com/gif.latex?\boldsymbol{\beta_{lc}}\simStudent\_t(6,\boldsymbol{\beta_l},\boldsymbol{\sigma_{l}}))  
